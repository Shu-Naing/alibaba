...
@section('cardbody')
    <div class="container-fluid main-content">
        ...
        {!! Form::open(array('route' => 'distribute.store', 'method' => 'post', 'class' => 'p-4 rounded border shadow-sm mb-5', 'id' => 'distribute')) !!}
            @csrf
            <div class="row mb-3 g-3">
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                    ...
                    {!! Form::select('from_outlet',$outlets, null, array('placeholder' => 'Choose From outlets', 'class' => 'form-control','id'=>'fromOutlet')) !!}
                </div>
                 <div class="col-md-4">
                    {!! Form::label('to_outlet', 'To (Outlet)', array('class' => 'form-label')) !!}
                    {!! Form::select('to_outlet',$outlets, null, array('placeholder' => 'Choose to outlets', 'class' => 'form-control','id'=>'toOutlet')) !!}
                </div>
            </div>
        {!! Form::close() !!}
