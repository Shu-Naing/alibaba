        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
                    aria-describedby="emailHelp" value="{{ old('name', $sellingprice->name) }}">
                @error('name')
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control @error('descriptions') is-invalid @enderror" name="descriptions" id="descriptions"
                    style="height: 200px;">{{ old('descriptions', $sellingprice->descriptions) }}</textarea>
                @error('descriptions')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
