...
{!! Form::model($noti, [ 'method' => 'PATCH', 'route' => ['notifications.update', $noti->id], 'enctype' => 'multipart/form-data']) !!}
<div class="row">
<div class="col-xs-6 col-sm-6 col-md-6">
    ...
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
            <strong>Image:</strong>
            {!! Form::file('image', null, array('accept' => '.jpg,.jpeg,.png', 'placeholder' => 'Image','class' => 'form-control')) !!}
        </div>
    </div>
