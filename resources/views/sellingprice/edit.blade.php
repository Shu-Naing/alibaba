        ...
        {!! Form::model($sellingprice, ['route' => ['sellingprice.update', $sellingprice->id], 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'px-3']) !!}
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        {!! Form::text('name', $sellingprice->name, array('class' => 'form-control mb-3', 'id'=>'name')) !!}
                    </div>
                    <div class="col-md-12">
                        {!! Form::label('descriptions', 'descriptions *', array('class' => 'form-label')) !!}
                        {!! Form::textarea('descriptions', $sellingprice->descriptions, array('class' => 'form-control mb-3','id'=>'descriptions', 'cols' => '40', 'rows' => '4')) !!}
                    </div>
                </div>
