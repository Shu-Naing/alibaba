...
@section('cardbody')
    <div class="container-fluid main-content">
        ...
        {!! Form::model($brands, ['route' => ['brands.update', $brands->id], 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'px-3']) !!}
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    {!! Form::label('brand_name', 'Name *', array('class' => 'form-label')) !!}
                    {!! Form::text('brand_name', $brands->name, array('class' => 'form-control mb-3', 'id'=>'brand_name')) !!}
                </div>
                <div class="col-md-12">
                    {!! Form::label('note', 'Short Description *', array('class' => 'form-label')) !!}
                    {!! Form::textarea('note', $brands->note, array('class' => 'form-control','id'=>'note', 'cols' => '40', 'rows' => '4')) !!}
                </div>
            </div>
