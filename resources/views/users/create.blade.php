                ...
                <div class="card p-3 border">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 my-3">
                            ...
                            {{ Form::select('outlet_id', ['' => 'Choose outlets'] + $outlets->pluck('name', 'id')->toArray(), null, ['class' => 'form-control'. ($errors->has('outlet_id') ? ' is-invalid' : '')]) }}
                            @error('outlet_id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            {{ Form::select('roles[]',$roles, [], ['class' => 'form-control' . ($errors->has('roles') ? ' is-invalid' : ''), 'multiple']) }}
                            @error('roles')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
