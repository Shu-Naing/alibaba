...
@section('cardbody')
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="emailHelp" value="{{ old('name', $units->name) }}">
            @error('name')
        ...
        <div class="col-md-12">
            ...
            <textarea class="form-control @error('short_name') is-invalid @enderror" name="short_name" id="short_name" style="height: 200px;">{{ old('short_name', $units->short_name) }}</textarea>
            @error('short_name')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
